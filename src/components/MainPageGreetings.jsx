            ...
            <div className={styles.mainPageCompsHolder}>
                    ...
                    <div className={styles.greetTextCont}>
                        <div className={styles.textCont}>
                            <div className={styles.mainTextCont}>
                                <span className={styles.mainText}>КУРС ДЛЯ ВОКАЛІСТІВ ЗА МЕТОДИКОЮ
                                    ESTILL VOICE
                                </span>
                            </div>
                            <div className={styles.secondaryTextCont}>
                                <span className={styles.secondaryText}>Хочеш навчатись прямо зараз?</span>
                ...
                <div className={styles.swipeBlockCont}>
                    ...
                    <div className={styles.btnConteiner}>
                        <AnchorLink href="#pro-course"><ArrowIcon /></AnchorLink>
                    </div>
                </div>
